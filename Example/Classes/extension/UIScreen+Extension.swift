...
extension UIScreen {
    ...
    屏幕形状
     */
    public static var screenShape: ScreenShape {
    ...
    /**
     刘海 宽度
     */
    public static var notchWidth: CGFloat {
        switch UIDevice.deviceName {
        case .iPhoneX1:
            return 230
        case .iPhoneX2:
    ...
    /**
     刘海高度
     */
    public static var notchHeight: CGFloat {
        switch UIDevice.deviceName {
        case .iPhoneX1:
            return 32
        case .iPhoneX2:
...
extension UIScreen {
    ...
    public static var dynamicIslandPath: UIBezierPath {
